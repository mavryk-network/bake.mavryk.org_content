...
5. *Adoption* The proposal is officially accepted and goes into effect at the end of the *Adoption* stage. The Basenet test network is upgraded as a final test before Mainnet adoption. Dapp developers make sure this proposal doesn't break their dapps and make any necessary changes to their dapps.

We recommend you read more about the Mavryk Voting process here: https://protocol.mavryk.org/active/voting.html

## Proposal voting with MavGov

MavGov allows you to participate in Mavryk proposal voting with your Ledger hardware wallet. 
...
* Use the Beacon method if you are using a Beacon enabled wallet like Mavryk or Kukai. In this case you will not see the exact details of your vote on your Ledger screen and you will instead be asked to sign an arbitrary blob message. This method also works fine but it is inherently less secure than the direct Ledger method

![<MavGov login home screen>](/mavgov/tutorial/mavgovHome.png) 

Once logged in you'll see the MavGov home screen. You can see the current cycle, the current proposal, the current voting period, and the current voting period progress. You can also see the current proposal status and the current proposal details.
...
![<MavGov login home screen>](/mavgov/tutorial/mavgovPromotion.png)

 You will be asked to confirm the vote on your Ledger device. 

![<MavGov login home screen>](/mavgov/tutorial/mavgovPromotionConfirm.png)

Once confirmed, the page will refresh within 30 seconds.

![<MavGov login home screen>](/mavgov/tutorial/mavgovPromotionConfirm2.png)

After finished, you'll be able to click on the confirmation link for your vote.

![<MavGov login home screen>](/mavgov/tutorial/mavgovPromotionConfirm3.png)
...
![<MavGov Cooldown period](/mavgov/tutorial/mavgovCooldown.png) 
