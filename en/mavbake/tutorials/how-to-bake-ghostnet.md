...
weight: 1
type: docs
summary: Using MavBake to bake on the Ghostnet Tezos perpetual testnet
---

## Ghostnet

Ghostnet is Tezos' perpetual testnet. In the context of MavBake, Ghostnet is
...
### Setup Tezos node, signer and install mavbake dependencies
   ...
   ```
   mavbake setup -a --node-configuration=https://raw.githubusercontent.com/tez-capital/xtz.configs/main/ghostnet.json
   # you may be prompted for sudo password
   ```
